  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        {trigger || (
          <Button className="rounded-md border border-border shadow-sw-default hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all">
            <UploadIcon className="w-4 h-4 mr-2" />
            {t('dashboard.uploadResume')}
          </Button>
        )}
      </DialogTrigger>
      <DialogContent className="sm:max-w-md bg-background border border-border shadow-sw-lg p-0 gap-0 rounded-lg">
        ...
        <div className="p-6 bg-background">
          <div
            className={`
                            ...
                            ${isDragging ? 'border-primary bg-primary/10' : 'border-steel-grey hover:border-border hover:bg-card'}
            ...
            {isUploadingGlobal ? (
              ...
              <div className="flex items-center justify-between gap-4">
                ...
                <Button
                  ...
                  className="hover:bg-destructive/10 text-destructive rounded-md"
              ...
              <div className="flex flex-col items-center py-4">
                <div className="w-12 h-12 border border-border bg-card shadow-sw-default flex items-center justify-center mb-4">
          ...
          {displayErrors.length > 0 && (
            <div className="mt-4 p-3 bg-destructive/10 border border-destructive/20 flex items-start gap-2 text-destructive text-sm">
          ...
          {uploadFeedback?.type === 'success' && (
            <div className="mt-4 p-3 bg-success/10 border border-success/20 flex items-center gap-2 text-success text-sm font-bold">
        ...
        <div className="p-4 border-t border-border bg-card flex justify-end gap-2">
          {uploadFeedback?.type === 'error' && failedResumeId && (
            <Button
              variant="outline"
              className="rounded-md border-border hover:bg-paper-tint"
          ...
          <DialogClose asChild>
            <Button variant="outline" className="rounded-md border-border hover:bg-paper-tint">
              {t('common.cancel')}
            </Button>
          </DialogClose>
        </div>

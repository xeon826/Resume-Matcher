    ...
    >
      ...
      <div className="w-full max-w-[86rem] max-h-full border border-border bg-background shadow-sw-lg flex flex-col overflow-hidden">
        ...
        <div className="border-b border-border p-8 md:p-12 shrink-0 bg-background relative z-30">
          <h1 className="font-sans text-5xl md:text-7xl text-foreground tracking-tight leading-[0.95] uppercase">
            {t('nav.dashboard')}
          </h1>
        ...
        <div className="@container flex-1 overflow-y-auto overflow-x-hidden relative z-10">
          <div className="p-[1.5px]">
            <div className="grid grid-cols-1 @2xl:grid-cols-2 @3xl:grid-cols-3 @5xl:grid-cols-5 bg-border gap-[1px] border-b border-border">
              {children}
            </div>
          </div>
        </div>
        ...
        <div className="p-4 bg-background flex justify-between items-center font-mono text-xs text-primary border-t border-border shrink-0 relative z-30">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/tracker"
              className="inline-flex items-center justify-center gap-2 bg-background text-foreground border border-border px-6 py-2 uppercase font-bold tracking-wide shadow-sw-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all min-w-[140px] text-center"
            >
            ...
            <Link
              href="/settings"
              className="bg-warning text-foreground border border-border px-6 py-2 uppercase font-bold tracking-wide shadow-sw-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all min-w-[140px] text-center"
            >
              {t('nav.settings')}
            </Link>
          </div>

    ...
    <div className="min-h-screen w-full bg-background flex flex-col items-center justify-center p-4 md:p-8 font-sans">
      <div className="w-full max-w-4xl bg-card border border-border shadow-sw-lg p-8 md:p-12 lg:p-14 relative">
        ...
        <div className="mb-8 mt-4 text-center">
          <h1 className="font-sans text-4xl font-bold uppercase tracking-tight mb-2">
            {t('tailor.heroTitle')}
          </h1>
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            <Textarea
              ...
              className="min-h-[300px] font-mono text-sm bg-background border-2 border-border focus:ring-0 focus:border-primary resize-none p-4 rounded-md"
